...
$bytes = (Invoke-WebRequest "https://release-download.static.cloudmoe.com/TGSAN/CMWTAT_Digital_Edition/releases/download/3.0.0.0/CMWTAT_Digital_Release_3_0_0_0.exe").Content
